@echo off
title L2PS - SQL Account Manager
color 17
java -Djava.util.logging.config.file=console.cfg -cp ./../libs/*;L2PS_Connect.jar com.l2jserver.tools.accountmanager.SQLAccountManager 2> NUL
if %errorlevel% == 0 (
echo.
...
echo.
echo An error has occurred while running the L2PS Account Manager!
echo.

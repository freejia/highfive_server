...
public final class Formulas
{
	...
	public static final double calcHpRegen(L2Character cha)
	{
		...
		if (Config.EASY_CHAMPION_ENABLE && cha.isEasyChampion())
		{
			hpRegenMultiplier *= Config.EASY_CHAMPION_HP_REGEN;
		}
		else if (Config.HARD_CHAMPION_ENABLE && cha.isHardChampion())
		{
			hpRegenMultiplier *= Config.HARD_CHAMPION_HP_REGEN;
		}
	...
	public static double calcBlowDamage(L2Character attacker, L2Character target, L2Skill skill, byte shld, boolean ss)
	{
		...
		{
			if ((target instanceof L2PcInstance) && ((attacker.getActiveClass() == ClassId.treasureHunter.getId()) || (attacker.getActiveClass() == ClassId.plainsWalker.getId()) || (attacker.getActiveClass() == ClassId.abyssWalker.getId()) || (attacker.getActiveClass() == ClassId.adventurer.getId()) || (attacker.getActiveClass() == ClassId.windRider.getId()) || (attacker.getActiveClass() == ClassId.ghostHunter.getId()) || (attacker.getActiveClass() == ClassId.bountyHunter.getId()) || (attacker.getActiveClass() == ClassId.fortuneSeeker.getId())))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill != null))
					{
						damage /= Config.DAGGER_VS_HEAVY;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill != null))
					{
						damage /= Config.DAGGER_VS_LIGHT;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill != null))
					{
		...
		if (Config.CLASS_BALANCE)
		{
			if ((target instanceof L2PcInstance) && ((attacker.getActiveClass() == ClassId.treasureHunter.getId()) || (attacker.getActiveClass() == ClassId.plainsWalker.getId()) || (attacker.getActiveClass() == ClassId.abyssWalker.getId()) || (attacker.getActiveClass() == ClassId.adventurer.getId()) || (attacker.getActiveClass() == ClassId.windRider.getId()) || (attacker.getActiveClass() == ClassId.ghostHunter.getId()) || (attacker.getActiveClass() == ClassId.bountyHunter.getId()) || (attacker.getActiveClass() == ClassId.fortuneSeeker.getId())))
			{
				...
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.DAGGER_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.DAGGER_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.DAGGER_VS_ROBE_AUTOATTACK;
					}
				}
			}
			
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BOW)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.ARCHER_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.ARCHER_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.ARCHER_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BOW) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BLUNT)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.BLUNT_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.BLUNT_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.BLUNT_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BLUNT) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUALFIST)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.FIST_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.FIST_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.FIST_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUALFIST) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUAL)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.DUAL_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.DUAL_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.DUAL_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUAL) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.SWORD)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.SWORD_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.SWORD_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.SWORD_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.SWORD) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.POLE)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.POLE_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.POLE_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.POLE_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.POLE) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BIGBLUNT)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.BIGBLUNT_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.BIGBLUNT_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.BIGBLUNT_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BIGBLUNT) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BIGSWORD)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.BIGSWORD_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.BIGSWORD_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.BIGSWORD_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BIGSWORD) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.RAPIER)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.RAPIER_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.RAPIER_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.RAPIER_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.RAPIER) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.ANCIENTSWORD)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.ANCIENTSWORD_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.ANCIENTSWORD_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.ANCIENTSWORD_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.ANCIENTSWORD) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.CROSSBOW)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.CROSSBOW_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.CROSSBOW_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.CROSSBOW_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.CROSSBOW) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
			...
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUALDAGGER)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill == null))
					{
						damage /= Config.DUALDAGGER_VS_HEAVY_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill == null))
					{
						damage /= Config.DUALDAGGER_VS_LIGHT_AUTOATTACK;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill == null))
					{
						damage /= Config.DUALDAGGER_VS_ROBE_AUTOATTACK;
					}
				}
			}
			if ((attacker.isPlayer() && (target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUALDAGGER) && (skill != null)))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
	...
	public static final double calcMagicDam(L2Character attacker, L2Character target, L2Skill skill, byte shld, boolean ss, boolean bss, boolean mcrit)
	{
		...
		if (Config.CLASS_BALANCE)
		{
			if ((target instanceof L2PcInstance) && ((attacker.getActiveClass() == ClassId.necromancer.getId()) || (attacker.getActiveClass() == ClassId.sorceror.getId()) || (attacker.getActiveClass() == ClassId.spellhowler.getId()) || (attacker.getActiveClass() == ClassId.soultaker.getId()) || (attacker.getActiveClass() == ClassId.mysticMuse.getId()) || (attacker.getActiveClass() == ClassId.stormScreamer.getId())))
			{
				L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
				if (armor != null)
				{
					if (((L2PcInstance) target).isWearingHeavyArmor() && (skill != null))
					{
						damage /= Config.MAGE_VS_HEAVY;
					}
					if (((L2PcInstance) target).isWearingLightArmor() && (skill != null))
					{
						damage /= Config.MAGE_VS_LIGHT;
					}
					if (((L2PcInstance) target).isWearingMagicArmor() && (skill != null))
					{
						damage /= Config.MAGE_VS_ROBE;
					}
				}
			}
		}

...
public class PcStat extends PlayableStat
{
	...
	/*
	 * public static boolean isPlayerNearVillageMaster(L2PcInstance player, int radius) { final PcKnownList knowList = player.getKnownList(); for (L2Character chr : knowList.getKnownCharactersInRadius(radius)) { if ((chr != null) && (chr instanceof L2VillageMasterInstance)) { return true; } } return
	 * false; }
	 */
	...
	public boolean addExp(long value)
	{
		...
		/*
		 * if (isPlayerNearVillageMaster(activeChar, 2000)) { _log.info("Someone trying to bug subclass, but this bug not working on L2PS"); return false; }
		 */
	...
	public final boolean addLevel(byte value)
	{
		...
		getActiveChar().incAdventPoints(600, false);

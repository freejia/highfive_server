...
public final class SpawnTable
{
	...
	// SQL
	private static final String SELECT_SPAWNS = "SELECT spawn_name, count, npc_templateid, locx, locy, locz, heading, respawn_delay, respawn_random, loc_id, periodOfDay FROM spawnlist";

 ...
 * @RobikBobik
 */
public class ContactManager extends BaseBBSManager
{
	...
	public void parsecmd(String command, L2PcInstance activeChar)
	{
		...
		{
			sendHtm(activeChar, "data/html/CommunityBoard/ContactInfo.htm");
		}
		else
		{
	...
	{
		protected static final ContactManager _instance = new ContactManager();
	}
}
 ...
 * @author RobíkBobík
 */
public class ExFreyaSendUIEvent extends L2GameServerPacket
{
	 ...
	 * @param text
	 */
	public ExFreyaSendUIEvent(L2PcInstance player, boolean hide, boolean countUp, int startTime, int endTime, String text)
	{
	 ...
	 * @param params
	 */
	public ExFreyaSendUIEvent(L2PcInstance player, boolean hide, boolean countUp, int startTime, int endTime, NpcStringId npcString, String... params)
	{
	 ...
	 * @param params
	 */
	public ExFreyaSendUIEvent(L2PcInstance player, boolean hide, boolean countUp, int startTime, int endTime, int npcstringId, String... params)
	{

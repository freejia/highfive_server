...
{
	// Kind of punish
	private final Punish _botPunishment;
	...
	{
		if ((_botPunishment == Punish.MOVEBAN) && ((System.currentTimeMillis() - _punishTime) <= 0))
		{
			return false;
		}
		return true;
	...
	{
		if ((_botPunishment == Punish.CHATBAN) && ((System.currentTimeMillis() - _punishTime) <= 0))
		{
			return false;
		}
		return true;
	...
	{
		if ((_botPunishment == Punish.PARTYBAN) && ((System.currentTimeMillis() - _punishTime) <= 0))
		{
			return false;
		}
		return true;
	...
	{
		if ((_botPunishment == Punish.ACTIONBAN) && ((System.currentTimeMillis() - _punishTime) <= 0))
		{
			return false;
		}
		return true;

...
public class CaptchaPunishmentDAO
{
	...
	public static final String SELECT_SQL_QUERY = "SELECT count FROM report_data WHERE obj_id = ?";
	public static final String UPDATE_SQL_QUERY = "UPDATE report_data SET count = ? WHERE obj_id = ?";
	public static final String INSERT_SQL_QUERY = "INSERT INTO report_data (obj_id,count) VALUES(?,?)";

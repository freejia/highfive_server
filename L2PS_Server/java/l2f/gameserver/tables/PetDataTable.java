...
public class PetDataTable
{
	...
	private void load()
	{
		...
		{
			_log.error("Error while loading Pet Data", e);
		}
		finally
		{
	...
	public static void deletePet(ItemInstance item, Creature owner)
	{
		...
		{
			_log.error("Could not restore pet object id", e);
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
	...
	public static enum L2Pet
	{
		...
		SIEGEWYVERN(WYVERN_ID, 24003, 6316, true, 1, 12, .0, 2, 2),
		...
		FOX_SHAMAN_EVENT(FOX_SHAMAN_ID, 13306, -1, false, 25, 12, .30, 2, 2),
		WILD_BEAST_FIGHTER(WILD_BEAST_FIGHTER_ID, 13019, -1, false, 25, 12, .30, 2, 2),
		WILD_BEAST_FIGHTER_EVENT(WILD_BEAST_FIGHTER_ID, 13305, -1, false, 25, 12, .30, 2, 2),
		WHITE_WEASEL(WHITE_WEASEL_ID, 13017, -1, false, 25, 12, .30, 2, 2),
		WHITE_WEASEL_EVENT(WHITE_WEASEL_ID, 13303, -1, false, 25, 12, .30, 2, 2),
		FAIRY_PRINCESS(FAIRY_PRINCESS_ID, 13018, -1, false, 25, 12, .30, 2, 2),
		FAIRY_PRINCESS_EVENT(FAIRY_PRINCESS_ID, 13304, -1, false, 25, 12, .30, 2, 2),
		OWL_MONK(OWL_MONK_ID, 13550, -1, false, 25, 12, .30, 2, 2),
		OWL_MONK_EVENT(OWL_MONK_ID, 14063, -1, false, 25, 12, .30, 2, 2),
		SPIRIT_SHAMAN(SPIRIT_SHAMAN_ID, 14062, -1, false, 25, 12, .30, 2, 2),
		SOUL_MONK(SPIRIT_SHAMAN_ID, 13549, -1, false, 25, 12, .30, 2, 2),
		TOY_KNIGHT(TOY_KNIGHT_ID, 14061, -1, false, 25, 12, .30, 2, 2),
		TOY_KNIGHT_2(TOY_KNIGHT_ID, 13548, -1, false, 25, 12, .30, 2, 2),
		TURTLE_ASCETIC(TURTLE_ASCETIC_ID, 14064, -1, false, 25, 12, .30, 2, 2),
		TURTLE_ASCETIC_2(TURTLE_ASCETIC_ID, 13551, -1, false, 25, 12, .30, 2, 2),
		...
		ROSE_DESELOPH(ROSE_DESELOPH_ID, 20908, -1, false, 55, 12, .3, 2, 2),
		ROSE_HYUM(ROSE_HYUM_ID, 20909, -1, false, 55, 12, .3, 2, 2),
		ROSE_REKANG(ROSE_REKANG_ID, 20910, -1, false, 55, 12, .3, 2, 2),
		ROSE_LILIAS(ROSE_LILIAS_ID, 20911, -1, false, 55, 12, .3, 2, 2),
		ROSE_LAPHAM(ROSE_LAPHAM_ID, 20912, -1, false, 55, 12, .3, 2, 2),
		ROSE_MAPHUM(ROSE_MAPHUM_ID, 20913, -1, false, 55, 12, .3, 2, 2),

		IMPROVED_ROSE_DESELOPH(IMPROVED_ROSE_DESELOPH_ID, 20915, -1, false, 55, 12, .3, 2, 2),
		IMPROVED_ROSE_HYUM(IMPROVED_ROSE_HYUM_ID, 20916, -1, false, 55, 12, .3, 2, 2),
		IMPROVED_ROSE_REKANG(IMPROVED_ROSE_REKANG_ID, 20917, -1, false, 55, 12, .3, 2, 2),
		IMPROVED_ROSE_LILIAS(IMPROVED_ROSE_LILIAS_ID, 20918, -1, false, 55, 12, .3, 2, 2),
		IMPROVED_ROSE_LAPHAM(IMPROVED_ROSE_LAPHAM_ID, 20919, -1, false, 55, 12, .3, 2, 2),
		IMPROVED_ROSE_MAPHUM(IMPROVED_ROSE_MAPHUM_ID, 20920, -1, false, 55, 12, .3, 2, 2);

...
public class Config
{
	...
	// TODO
	public static boolean BBS_COMMISSION_ALLOW = false;
	public static int[] BBS_COMMISSION_ARMOR_PRICE = null;
	public static int[] BBS_COMMISSION_WEAPON_PRICE = null;
	public static int[] BBS_COMMISSION_JEWERLY_PRICE = null;
	public static int[] BBS_COMMISSION_OTHER_PRICE = null;
	public static Object[] BBS_COMMISSION_ALLOW_ITEMS = null;
	public static int BBS_COMMISSION_MAX_ENCHANT = 0;
	public static Object[] BBS_COMMISSION_NOT_ALLOW_ITEMS = null;
	public static boolean BBS_COMMISSION_ALLOW_UNDERWEAR = false;
	public static boolean BBS_COMMISSION_ALLOW_CLOAK = false;
	public static boolean BBS_COMMISSION_ALLOW_BRACELET = false;
	public static boolean BBS_COMMISSION_ALLOW_AUGMENTED = false;
	public static int BBS_COMMISSION_COUNT_TO_PAGE = 0;
	public static int[] BBS_COMMISSION_MONETS = null;
	...
	public static List<Integer> ALT_OLY_WPERIOD = new ArrayList<>();
	...
	public static int OLY_POINT_MIN_LIMIT;
	...
	/** Ð’Ñ€ÐµÐ¼Ñ� Ð·Ð°Ð¿Ð»Ð°Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ð¾Ð³Ð¾ Ð½Ð° Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð½Ð¾Ðµ Ð²Ñ€ÐµÐ¼Ñ� Ñ�ÑƒÑ‚Ð¾Ðº Ñ€ÐµÑ�Ñ‚Ð°Ñ€Ñ‚Ð° */
	...
	public static boolean COMMUNITYBOARD_RANKING_ENABLED;
	...
	/* ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑ�Ñ‚Ð²Ð¾ Ð¾Ñ‡ÐºÐ¾Ð² Ñ€ÐµÐ¿ÑƒÑ‚Ð°Ñ†Ð¸Ð¸ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾Ðµ Ð´Ð»Ñ� Ð¿Ð¾Ð´Ð½Ñ�Ñ‚Ð¸Ñ� ÑƒÑ€Ð¾Ð²Ð½Ñ� ÐºÐ»Ð°Ð½Ñƒ. */
	...
	/* ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑ�Ñ‚Ð²Ð¾ Ñ‡ÐµÐ»Ð¾Ð²ÐµÐº Ð² ÐºÐ»Ð°Ð½Ðµ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾Ðµ Ð´Ð»Ñ� Ð¿Ð¾Ð´Ð½Ñ�Ñ‚Ð¸Ñ� ÑƒÑ€Ð¾Ð²Ð½Ñ� ÐºÐ»Ð°Ð½Ñƒ. */
	...
	public static void loadServerConfig()
	{
		...
		VOTE_ADDRESS = serverSettings.getProperty("VoteAddress", "http://l2tales.com/check/StringTake.php?IP=");
	...
	public static void loadNpcConfig()
	{
		...
		DONATOR_NPC_ITEM = npcSettings.getProperty("DonatorNPCitem", 6673);
		DONATOR_NPC_ITEM_NAME = npcSettings.getProperty("DonatorNPCitemName", "Donator Coin");
		DONATOR_NPC_COUNT_FAME = npcSettings.getProperty("DonateFame", 10000);
		DONATOR_NPC_FAME = npcSettings.getProperty("DonateCountFame", 5);
		DONATOR_NPC_COUNT_REP = npcSettings.getProperty("DonateRep", 10000);
		DONATOR_NPC_REP = npcSettings.getProperty("DonateCountClanRep", 5);
		DONATOR_NPC_COUNT_NOBLESS = npcSettings.getProperty("DonateCountNobless", 5);
		DONATOR_NPC_COUNT_SEX = npcSettings.getProperty("DonateCountChangeSex", 5);
		DONATOR_NPC_COUNT_LEVEL = npcSettings.getProperty("DonateCountMaxLevel", 5);
	}
	...
	public static void loadOtherConfig()
	{
		...
		ALLOW_MACRO = otherSettings.getProperty("MacroBug", false);
	...
	public static void loadFormulasConfig()
	{
		...
		SKILLS_CHANCE_STUN = formulasSettings.getProperty("StunModChance", 0);
	}
	...
	public static void loadExtSettings()
	{
		...
		// Emulation OFF Core (packet SendStatus) by FandC-Team
	...
	public static void loadTopSettings()
	{
		...
		L2_TOP_SERVER_ADDRESS = topSetting.getProperty("L2TopServerAddress", "fandc.ro");
		...
		MMO_TOP_SERVER_ADDRESS = topSetting.getProperty("MMOTopServerAddress", "fandc.ro");
	...
	public static void loadCommunityPvPboardsettings()
	{
		...
		//commission
		BBS_COMMISSION_ALLOW = CommunityPvPboardSettings.getProperty("AllowCBCommission", false);
		BBS_COMMISSION_ARMOR_PRICE = CommunityPvPboardSettings.getProperty("CBCommissionArmorPrice", new int[] { 57 });
		BBS_COMMISSION_WEAPON_PRICE = CommunityPvPboardSettings.getProperty("CBCommissionWeaponPrice", new int[] { 100 });
		BBS_COMMISSION_JEWERLY_PRICE = CommunityPvPboardSettings.getProperty("CBCommissionJewerlyPrice", new int[] { 100 });
		BBS_COMMISSION_OTHER_PRICE = CommunityPvPboardSettings.getProperty("CBCommissionOtherPrice", new int[] { 100 });
		/*BBS_COMMISSION_ALLOW_ITEMS = CommunityPvPboardSettings.getProperty("CBCommissionAllowItems", new Object[]
		{

		});*/
		BBS_COMMISSION_MAX_ENCHANT = CommunityPvPboardSettings.getProperty("CBCommissionMaxEnchant", 16);
		/*BBS_COMMISSION_NOT_ALLOW_ITEMS = CommunityPvPboardSettings.getProperty("CBCommissionNotAllowItems", new Object[]
		{

		});*/
		BBS_COMMISSION_ALLOW_UNDERWEAR = CommunityPvPboardSettings.getProperty("AllowCBCommissionUnderwear", true);
		BBS_COMMISSION_ALLOW_CLOAK = CommunityPvPboardSettings.getProperty("AllowCBCommissionCloack", true);
		BBS_COMMISSION_ALLOW_BRACELET = CommunityPvPboardSettings.getProperty("AllowCBCommissionBracelet", true);
		BBS_COMMISSION_ALLOW_AUGMENTED = CommunityPvPboardSettings.getProperty("AllowCBCommissionAugmented", true);
		BBS_COMMISSION_COUNT_TO_PAGE = CommunityPvPboardSettings.getProperty("CBCommisionCountONPage", 15);
		/*BBS_COMMISSION_MONETS = CommunityPvPboardSettings.getProperty("CBCommissionMonets", new int[]
		{
		  100
		});*/
		...
		COMMUNITYBOARD_RANKING_ENABLED = CommunityPvPboardSettings.getProperty("RankingEnable", false);
	...
	public static void loadOlympiadSettings()
	{
		...
		for(String prop : olympSettings.getProperty("AltOlyWPeriod", "8,22").split(","))
		{
			ALT_OLY_WPERIOD.add(Integer.parseInt(prop));
		}
		...
		OLY_POINT_MIN_LIMIT = olympSettings.getProperty("MinimumPointsToRegister", 10);
	}
	...
	// ÐŸÐµÑ€ÐµÐ½Ð¾Ñ� Ð¿ÐµÑ€Ñ�Ð¾Ð½Ð°Ð¶ÐµÐ¹ Ð¼ÐµÐ¶Ð´Ñƒ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚Ð°Ð¼Ð¸
	...
	{
		ExProperties eventTeamVSTeamSettings = load(EVENT_KOREAN_STYLE_CONFIG_FILE);

		EVENT_KOREAN_WINNER_REWARDS = eventTeamVSTeamSettings.getProperty("Korean_Winner_Reward", "").trim().replaceAll(" ", "").split(";");
		EVENT_KOREAN_KILL_REWARD = eventTeamVSTeamSettings.getProperty("Korean_Kill_Reward", "").trim().replaceAll(" ", "").split(";");
		EVENT_KOREAN_TIME_TO_TP = eventTeamVSTeamSettings.getProperty("Korean_time", 5);
		EVENT_KOREAN_PLAYERS_IN_TEAM = eventTeamVSTeamSettings.getProperty("Korean_PlayersInTeam", 50);
		EVENT_KOREAN_MIN_LEVEL = eventTeamVSTeamSettings.getProperty("Korean_MinLevel", 80);
		EVENT_KOREAN_MAX_LEVEL = eventTeamVSTeamSettings.getProperty("Korean_MaxLevel", 85);
		EVENT_KOREAN_REFLECTIONS = eventTeamVSTeamSettings.getProperty("Korean_Reflections", "").trim().replaceAll(" ", "").split(";");
		EVENT_KOREAN_ALLOW_BUFFS = eventTeamVSTeamSettings.getProperty("Korean_AllowBuffs", false);
		EVENT_KOREAN_CHECK_WINDOW_METHOD = eventTeamVSTeamSettings.getProperty("Korean_CheckWindowMethod", "IP");
		EVENT_KOREAN_BUFF_PLAYERS = eventTeamVSTeamSettings.getProperty("Korean_BuffPlayers", false);
		EVENT_KOREAN_FIGHTER_BUFFS = eventTeamVSTeamSettings.getProperty("Korean_FighterBuffs", "").trim().replaceAll(" ", "").split(";");
		EVENT_KOREAN_MAGE_BUFFS = eventTeamVSTeamSettings.getProperty("Korean_MageBuffs", "").trim().replaceAll(" ", "").split(";");
		EVENT_KOREAN_SEC_UNTIL_KILL = eventTeamVSTeamSettings.getProperty("Korean_Sec_Until_Kill", 60);
		//EVENT_KOREAN_DISALLOWED_SKILLS = eventTeamVSTeamSettings.getProperty("Korean_DisallowedSkills", "").trim().replaceAll(" ", "").split(";");

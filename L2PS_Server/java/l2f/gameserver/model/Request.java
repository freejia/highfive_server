...
public class Request extends MultiValueSet<String>
{
	...
	public static enum l2fequestType
	{
		CUSTOM,
		PARTY,
		PARTY_ROOM,
	 ...
	 * Создает запрос
	 */
	public Request(l2fequestType type, Player requestor, Player reciever)
	{
	...
	public Request(l2fequestType type, Player requestor)
	{
		_id = _nextId.incrementAndGet();
		_requestor = requestor.getRef();
		_type = type;
	 ...
	 */
	public boolean isTypeOf(l2fequestType type)
	{
		return _type == type;
	}

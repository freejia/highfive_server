...
public abstract class SiegeEvent<R extends Residence, S extends SiegeClanObject> extends GlobalEvent
{
	...
	protected static void showResults()
	{
		...
		Clan[] result = new Clan[Math.min(25, clans.length)];
		...
		_resultsThread = ThreadPoolManager.getInstance().schedule(new Runnable()
		{
	...
	{
		private static final long serialVersionUID = -6378882732689488446L;

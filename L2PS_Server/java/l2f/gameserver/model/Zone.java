...
public class Zone
{
	...
	// Synerge - Better implementation for zone effects and damage threads
	...
	private final class SkillTimer implements Runnable
	{
		...
		public void run()
		{
			...
			// Synerge - Soporte para efectos de daño que se activan y desactivan segun tiempo online, como los de Den of Evil, que duran algo asi como 10 minutos activos y 1 minuto inactivos
	...
	private void checkEffects(Creature cha, boolean enter)
	{
		if (checkTarget(cha))
		{
			// Synerge - New implementation of zone effect and damage threads
			if (enter)
			{

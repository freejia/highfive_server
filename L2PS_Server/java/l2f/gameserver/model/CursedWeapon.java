...
public class CursedWeapon
{
	...
	/** Ð’Ñ‹Ð¿Ð°Ð´ÐµÐ½Ð¸Ðµ Ð¾Ñ€ÑƒÐ¶Ð¸Ñ� Ð¸Ð· Ð¼Ð¾Ð½Ñ�Ñ‚Ñ€Ð° */
	...
	/**
	 * Ð’Ñ‹Ð¿Ð°Ð´ÐµÐ½Ð¸Ðµ Ð¾Ñ€ÑƒÐ¶Ð¸Ñ� Ð¸Ð· Ð²Ð»Ð°Ð´ÐµÐ»ÑŒÑ†Ð°, Ð¸Ð»Ð¸ Ð¸Ñ�Ñ‡ÐµÐ·Ð½Ð¾Ð²ÐµÐ½Ð¸Ðµ Ñ� Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð½Ð¾Ð¹ Ð²ÐµÑ€Ð¾Ñ�Ñ‚Ð½Ð¾Ñ�Ñ‚ÑŒÑŽ.
	 * Ð’Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚Ñ�Ñ� Ð¿Ñ€Ð¸ Ñ�Ð¼ÐµÑ€Ñ‚Ð¸ Ð¸Ð³Ñ€Ð¾ÐºÐ°.
	 */
	...
	/** Ð²Ñ‹Ð·Ñ‹Ð²Ð°ÐµÑ‚Ñ�Ñ� Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ Ð¾Ñ€ÑƒÐ¶Ð¸Ñ� */
	...
	{
		if (isDropped() || getPlayerId() != player.getObjectId()) // Ð¾Ñ€ÑƒÐ¶Ð¸Ðµ ÑƒÐ¶Ðµ Ð² Ñ€ÑƒÐºÐ°Ñ… Ð¸Ð³Ñ€Ð¾ÐºÐ° Ð¸Ð»Ð¸ Ð½Ð¾Ð²Ñ‹Ð¹ Ð¸Ð³Ñ€Ð¾Ðº
		{
		...
		player.getLoc().setZ(player.getLoc().getZ()+100);
	...
	public void setPlayer(Player player)
	{
		if (player != null)
			...
			setPlayerId(getPlayerId()); // Ð´Ð»Ñ� Ñ‚Ð¾Ð³Ð¾ Ñ‡Ñ‚Ð¾ Ð±Ñ‹ Ñ�Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ objId, Ð½Ð¾ Ð½Ðµ Ð¸Ñ�ÐºÐ°Ñ‚ÑŒ Ð¸Ð³Ñ€Ð¾ÐºÐ° Ð² Ñ…Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ðµ
	}
	...
	/**
	 * Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÑ‚ Ð¿Ð¾Ð·Ð¸Ñ†Ð¸ÑŽ (x, y, z)
	 * @return Location
	 */

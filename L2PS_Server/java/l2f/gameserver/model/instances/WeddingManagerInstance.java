...
public class WeddingManagerInstance extends NpcInstance
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7665950223138975019L;
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("AskWedding"))
		{
			...
			else if (player.getAdena() < (long) Config.WEDDING_PRICE)
			{
			...
			else
			{
				...
				player.reduceAdena((long) Config.WEDDING_PRICE, true, "AskWedding");
				sendHtmlMessage(player, filename, replace);
				return;
			}
		}

...
public abstract class Creature extends GameObject
{
	...
	public void callSkill(Skill skill, List<Creature> targets, boolean useActionSkills)
	{
		...
		catch(Exception e)
		{
			...
			_log.error(skill != null ? skill.getName() : "Unknown" + target + ", useActionSkills: " + useActionSkills);
	...
	public void doCast(Skill skill, Creature target, boolean forceUse)
	{
		...
		if(disallowSkill)
		{
			this.getPlayer().sendMessage("Action is not allowed");
			return;
		}
	...
	public double getReceivedDebuffMod(int skillId, double currentChance)
	{
		...
		long dateOfDebuffEnd = receivedDebuffs.containsKey(skillId) ? receivedDebuffs.get(skillId)[0].longValue() : 0L;
		double lastDebuffPeriod = receivedDebuffs.containsKey(skillId) ? receivedDebuffs.get(skillId)[1].longValue() / 1000L : 1L;

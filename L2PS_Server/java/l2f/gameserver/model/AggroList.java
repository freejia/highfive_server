...
public class AggroList
{
	...
	public Creature getTopDamager()
	{
		...
		// Synerge - For raids I add a custom sorting maxDealer function. Because its not for single damager, but add up all the party's damage
		if (npc.isRaid())
		{
			...
			for (AggroInfo ai : hated)
			{
				...
				for (Creature cha : chars)
				{
					...
					{
						partyId = cha.getPlayer().getParty().getPartyId();

...
{
	public static final int DISABLED = 0; // Ð²Ñ�Ðµ Ð´Ð¸Ð°Ð»Ð¾Ð³Ð¸ ÐºÐµÑˆÐ¸Ñ€ÑƒÑŽÑ‚Ñ�Ñ� Ð¿Ñ€Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐµ Ñ�ÐµÑ€Ð²ÐµÑ€Ð°
	public static final int LAZY = 1; // Ð´Ð¸Ð°Ð»Ð¾Ð³Ð¸ ÐºÐµÑˆÐ¸Ñ€ÑƒÑŽÑ‚Ñ�Ñ� Ð¿Ð¾ Ð¼ÐµÑ€Ðµ Ð¾Ð±Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ�
	public static final int ENABLED = 2;  // ÐºÐµÑˆÐ¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾ (Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð´Ð»Ñ� Ñ‚ÐµÑ�Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ�)
	...
	private void load(Language lang, File f, final String rootPath)
	{
		...
		//FIXME [VISTALL] Ð¼Ð¾Ð¶ÐµÑ‚ Ð»ÑƒÑ‡ÑˆÐµ Ð¸Ñ�Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÑŒ Apache FileUtils?
		for (File file : files)
		{
			if (file.isDirectory())

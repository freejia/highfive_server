...
public class DefaultAI extends CharacterAI
{
	...
	protected boolean checkAggression(Creature target, boolean avoidAttack)
	{
		...
		// Synerge - Posibility to call checkAggresion as a check without action
		if (!avoidAttack)
		{
	...
	protected boolean thinkActive()
	{
		...
		if ((now - _checkAggroTimestamp) > Config.AGGRO_CHECK_INTERVAL)
		{
			...
			{
				/*
				 * Synerge - Changed completely the logic. Now we get the surroundings, then check the aggresion of everyone and make a final list of possible targets

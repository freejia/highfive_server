...
import l2f.gameserver.handler.voicecommands.impl.BotReport.CaptchaHandler;
...
public class RequestActionUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (action.type == 4)
		{
			...
			if (pcTarget.isProcessingRequest() && pcTarget.getRequest().isTypeOf(l2fequestType.COUPLE_ACTION))
			{
			...
			new Request(l2fequestType.COUPLE_ACTION, activeChar, pcTarget).setTimeout(10000L);

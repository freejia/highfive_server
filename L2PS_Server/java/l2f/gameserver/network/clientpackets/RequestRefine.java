...
public final class RequestRefine extends L2GameClientPacket
{
	...
	boolean TryAugmentItem(Player player, ItemInstance targetItem, ItemInstance refinerItem, ItemInstance gemstoneItem)
	{
		...
		if (!player.getInventory().destroyItemByObjectId(_gemstoneItemObjId, modifyGemstoneCount, "Refine"))
			return false;

		// consume the life stone
		if (!player.getInventory().destroyItemByObjectId(_refinerItemObjId, 1L, "Refine"))
			return false;

...
/**
 * Π—Π°ΠΏΡ€ΠΎΡ� Π½Π° ΠΎΡ‚Ρ�Ρ‹Π»ΠΊΡƒ Π½ΠΎΠ²ΠΎΠ³ΠΎ ΠΏΠΈΡ�Ρ�ΠΌΠ°. Π’ ΠΎΡ‚Π²ΠµΡ‚ Ρ�Π»ΠµΡ‚Ρ�Ρ� {@link ExReplyWritePost}.
 *
...
public class RequestExSendPost extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.getLevel() <= Config.CHATS_REQUIRED_LEVEL && activeChar.getSubClasses().size() <= 1)
		{
			activeChar.sendMessage("Mail is allowed only for characters with level higher than " + Config.CHATS_REQUIRED_LEVEL + " to avoid spam!");
			return;
		}

...
public class CharInfo extends L2GameServerPacket
{
	...
	public CharInfo(Creature cha, Player forPlayer)
	{
		...
		// Ä�ĹşĹ�â‚¬Ä�ÄľÄ�ĹźÄ�Â»Ĺ�ĹąĹ�â€šÄ�ÄľÄ�Âµ Ä�ÄľĹ�â‚¬Ĺ�ďż˝Ä�Â¶Ä�Â¸Ä�Âµ Ä�Â¸ Ĺ�â€šĹ�â‚¬Ä�Â°Ä�ËťĹ�ďż˝Ĺ�â€žÄ�ÄľĹ�â‚¬Ä�Ä˝Ä�Â°Ĺ�â€ Ä�Â¸Ä�Â¸ Ä�Â´Ä�Â»Ĺ�Ĺą Ä�Ë�Ä�â€™ Ĺ�ďż˝Ä�ĹźĹ�â‚¬Ĺ�â€ąÄ�Ë›Ä�Â°Ĺ�Ĺ˝Ĺ�â€š Ä�Â¸Ä�Ä˝Ĺ�Ĺą Ä�Â¸ Ä�Ë›Ĺ�ďż˝Ä�Âµ Ä�ÄľĹ�ďż˝Ĺ�â€šÄ�Â°Ä�Â»Ĺ�ĹšÄ�ËťĹ�â€ąÄ�Âµ Ä�ÄľÄ�ĹĽÄ�ÄľÄ�Â·Ä�ËťÄ�Â°Ä�Ë›Ä�Â°Ĺ�â€šÄ�ÂµÄ�Â»Ĺ�ĹšÄ�ËťĹ�â€ąÄ�Âµ Ä�Â·Ä�ËťÄ�Â°Ä�ĹźÄ�Â¸
		...
		{
			_inv[PAPERDOLL_ID][0] = player.isInOlympiadMode() || forPlayer.getVarObject("showVisualChange") == null ? player.getInventory().getPaperdollItemId(PAPERDOLL_ID) : player.getInventory().getPaperdollVisualItemId(PAPERDOLL_ID);
